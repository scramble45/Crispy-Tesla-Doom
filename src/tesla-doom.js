...
var wasmBinaryFile = "tesla-doom.wasm";
...
function writeSockaddr(sa, family, addr, port, addrlen) {
 ...
 case 2:
  ...
  SAFE_HEAP_STORE(sa + 8 | 0, tempI64[0] | 0, 4), SAFE_HEAP_STORE(sa + 12 | 0, tempI64[1] | 0, 4);
  break;

...
cd textscreen
rm -fr Makefile Makefile.in .deps *.o *.a *.js *.wasm *.wasm.map
cd fonts
...
cd src
rm -fr Makefile Makefile.in .deps *.o *.a .deps chocolate* org.chocolate_doom* Doom.desktop Doom.metainfo.xml Doom_Screensaver.desktop *.js *.wasm *.map
cd doom
rm -fr Makefile Makefile.in .deps *.o *.a .deps
cd ../..
